...
import { getEspecialidades, getParteCorpoPorEspecialidade, getPartesCorpo } from "../servicos.js";
...
document.getElementById("botao_salvar_criacao_servico").addEventListener("click", 
    () => 
    {
        // console.log("teste")
