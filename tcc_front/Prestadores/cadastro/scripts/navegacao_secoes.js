...
// const colorir_indicadores = (secao_atual) =>
// {
//     let contador = 1;

//     document.querySelector(".bolinha").style.backgroundColor = "transparent"
//     // while (contador <= secao_atual)
//     {
//         document.querySelector(`.bolinha${contador}`).style.backgroundColor = "transparent"
//     }
