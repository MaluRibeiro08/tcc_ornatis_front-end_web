...
const input_imagem_estabelecimento = document.getElementById("input_foto_estabelecimento")
const input_imagem_administrador = document.getElementById("input_foto_administrador")
...
const prepararDadosParaSalvar = () =>
{
    ...
    // data['imagem_perfil_estabelecimento'] = input_imagem_estabelecimento.src;
    data['telefone'] = input_contato.value;
    data['cnpj'] = input_cnpj.value;

    //perfil administrador
    data['nome_adm'] = input_nome_adm.value;
    // data['imagem_perfil_administrador'] = input_imagem_administrador.src;
