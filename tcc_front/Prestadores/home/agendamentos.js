...
const carregarAgendamentosEmpresa =   (id_empresa) => fetch(`http://localhost/tcc_ornatis_back-end/api-ornatis/rotas/adm/agendamento/?id_empresa=${id_empresa}&acao=listarAgendamentos`)
            ...
            <div class="container_informacoes_compromisso">
                ...
                <div class="container_demais_infos_compromisso">
                    <div class="container_info_salao_compromisso">
                        ...
                        <a class="nome_salao" id="${agendamento["id_empresa"]}" href="../visualizacaoPerfil/index.html?id_empresa=${agendamento["id_empresa"]}" target= "_blank">${agendamento["nome_consumidor"]}</a>
                    </div>
...
export {carregarAgendamentosEmpresa, criar_lista_agendamentos}